        ...
        <header className="flex flex-col items-start gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="ml-auto whitespace-nowrap rounded-full border border-blush-100 bg-white/70 px-4 py-2 text-sm text-zinc-600 backdrop-blur">
                с любовью, Даня
              </span>
            </motion.div>
          </div>
